			...
			<div class="col-12">
				...
				<div class="row row--grid">
					...
					<div class="col-6 col-sm-4 col-md-3 col-xl-2">
						<a href="{{route('genredetail.list',$value->slug)}}" class="artist">
							<div class="artist__cover">
								<img style="height:200px; width:200px;"src="{{asset('upload/Genre/' .$value->image)}}" alt="">
							</div>
							<h3 class="artist__title">{{$value->title}}</h3>
						</a>
					</div>
					@endforeach
					@endif

                    ...
                    <ul>
                        <div class="favorites-container">
                            ...
                            <li class="single-item">
                                ...
                                <a data-playlist data-title="{{ $favorite->song->song_name }}" data-artist="{{ $favorite->song->artist_name }}" data-img="{{ asset('upload/Song/' . $favorite->song->image) }}" href="{{ asset('upload/Song/' . $favorite->song->audio) }}" class="single-item__cover">
                                    <img src="{{ asset('upload/Song/' . $favorite->song->image) }}" alt="">
                                ...
                                <div class="single-item__title">
                                    <h4>{{ $favorite->song->song_name }}</h4>
                                    <span>{{ $favorite->song->artist_name }}</span>
                                </div>

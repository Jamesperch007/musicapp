		...
		<div class="row row--grid">
			<div class="col-12">
				...
				<div class="main__title main__title--page">
					...
					<div>
						<h1 style="color: white;">{{ $Genredetails->title}}</h1>
						<span style="color: white;">{{ $Genredetails->slug}}</span>
					</div>
					<p>{!! html_entity_decode($Genredetails->description)!!}</p>
				...
				<div class="release">
					<div class="release__content">
						<div class="release__cover">
							<img src="{{ asset('upload/Genre/' . $Genredetails->image) }}" alt="{{ $Genredetails->genre }}">
						</div>
					</div>
					<ul>
						<div class="favorites-container">
							...
							@if ($Songsdetail->isNotEmpty())
							@foreach ($Songsdetail as $song)
							<ul class="main__list main__list--playlist main__list--dashbox">
								<li class="single-item">
									<a data-playlist data-title="{{ $song->song_name }}" data-artist="{{ $song->genre }}" data-genre="{{$song->title}}" data-img="{{ asset('upload/Song/' . $song->image) }}" href="{{ asset('upload/Song/' . $song->audio) }}" class="single-item__cover">
							...
							@endforeach
							@else
							<p style="color: white;">No songs available for this genre.</p>
							@endif
						</div>
					</ul>
				</div>

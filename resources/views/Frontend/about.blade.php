...
<main class="main">
		<div class="container-fluid">
			<div class="row row--grid">
				...
				<div class="col-12">
					<ul class="breadcrumb">
						<li class="breadcrumb__item"><a href="{{route('frontend.index')}}">Home</a></li>
				...
				<!-- title -->
				<div class="col-12">
					<div class="main__title" style="color: white;">
						<h1>About NEPMusic</h1>

						<p style="color: white;">Welcome to NEPMusic, your premier destination for streaming the best Nepali songs. Our platform is dedicated to bringing you the rich and diverse musical heritage of Nepal, from traditional folk tunes to the latest hits in contemporary Nepali music.</p>
						
						<h2 class="mt-4">Our Mission</h2>

						<p style="color: white;">At NEPMusic, our mission is to celebrate and promote Nepali music by providing an accessible and user-friendly platform for artists and listeners alike. We strive to create a space where music enthusiasts can discover, enjoy, and share their favorite Nepali songs.</p>

						<h2 class="mt-4">What We Offer</h2>
						<p><li>Vast Music Library: Explore our extensive collection of Nepali songs across various genres, including pop, rock, folk, classical, and more.</li>
						<li>Curated Playlists: Enjoy specially curated playlists that cater to your mood, whether you're looking for energetic tunes, relaxing melodies, or cultural classics.</li>
						<li>Personalized Experience: Create your own playlists, favorite songs, and get personalized recommendations based on your listening habits.</li>
						<li>High-Quality Streaming: Experience high-quality audio streaming that brings out the best in every song.</li></p>
					</div>
				</div>
				<!-- end title -->
				...
				<div class="col-12 col-lg-4">
					<div class="step">
						...
						<h3 class="step__title">Enjoy Blast music</h3>
			...
			<div class="row row--grid">
				...
				<div class="col-12 col-md-6 col-lg-4 order-md-2 order-lg-1">
					<div class="plan plan--green">
						...
						<ul class="plan__list">
							<li class="green"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.71,7.21a1,1,0,0,0-1.42,0L9.84,14.67,6.71,11.53A1,1,0,1,0,5.29,13l3.84,3.84a1,1,0,0,0,1.42,0l8.16-8.16A1,1,0,0,0,18.71,7.21Z"/></svg> Blast Originals</li>

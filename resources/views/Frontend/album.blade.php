			...
			<div class="col-12">
				...
				<div class="row row--grid">
					...
					<div class="col-6 col-sm-4 col-md-3 col-xl-2">
						<a href="{{route('albumdetail.list',$value->slug)}}" class="artist">
							<div class="artist__cover">
								<img style="height:200px; width:200px;" src="{{asset('upload/Album/' .$value->image)}}" alt="">
							</div>
							<h3 class="artist__title">{{$value->album_name}}</h3>
						</a>
					</div>
					@endforeach
					@endif

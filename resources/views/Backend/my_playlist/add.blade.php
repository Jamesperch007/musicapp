...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Add New MyPlaylist Details</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Add New MyPlaylist </li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">ADD New MyPlaylist Details</h3>
                        </div>
                        <form method="POST" action="{{route('my_playlist.store')}}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputName" name="playlist_name" placeholder="ENTER playlist name" value="{{old('playlist_name')}}">
                                        </div>
                                        @error('playlist_name')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputName" name="created_date" placeholder="ENTER Created Date" value="{{old('created_date')}}">
                                        </div>
                                        @error('created_date')
                                        <div class="text-red">{{ $message }}</div>

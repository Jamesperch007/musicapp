...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Add New  Songs Details</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Add New  Songs </li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">ADD New Songs Details</h3>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputName" name="plays" placeholder="ENTER plays" value="{{old('plays')}}">
                                        </div>
                                        @error('plays')
                                        <div class="text-red">{{ $message }}</div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputName" name="likes" placeholder="ENTER likes" value="{{old('likes')}}">
                                        </div>
                                        @error('likes')
                                        <div class="text-red">{{ $message }}</div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="exampleInputFile"> Songs</label>
